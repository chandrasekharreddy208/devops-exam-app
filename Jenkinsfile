pipeline {
    ...
    environment {
        DOCKER_IMAGE = "kubemcchandureddy/devopsexamapp:latest"
    }

    stages {
        stage('Git Checkout') {
            steps {
                git url: 'https://github.com/chandrasekharreddy208/devops-exam-app.git', 
                    branch: 'master'
            }
        }
...
pipeline {
    ...
    stages {
        stage('Git Checkout') {
            steps {
                git 'https://github.com/chandrasekharreddy208/devops-exam-app.git', 
                    branch: 'master'
            }
        }
